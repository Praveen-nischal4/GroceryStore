...
public class OrdersDAOImpl implements OrdersDAO {
	...
	public void saveToOrders(OrdersDTO ordersDTO) {
		String sql = "INSERT INTO orders (order_id,username,cart_id,item_id,item_name,price,quantity,order_date,delivery_date,delivery_address,couponApplied,email,mobile) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?)";
